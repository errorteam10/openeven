                  ...
                  <div class="card" style="height: 350px; overflow-y: scroll;">
                    ...
                    <hr>
                      <div class="list-group">
                        ...
                        <button type="button" class="list-group-item bg-dark text-light list-group-item-action" value="{{$item->id}}" owner="{{Auth()->User()->id}}" event="{{$item->event_id}}" id="past_{{$item->id}}">{{($item->event_name)}} [Purchased: {{($item->purchase_date)}}]</button>
                        @endforeach
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6"><div class="card" style="height: 350px; overflow-y: scroll;">
                  ...
                  <hr>
                    <div class="list-group">
                      ...
                      <button href="" class="list-group-item bg-dark text-light list-group-item-action" id="current_{{$item->id}}">{{($item->event_name)}} [Purchased: {{($item->purchase_date)}}]</button>
                      @endforeach
                    </div>
                  </div>
                </div></div>
